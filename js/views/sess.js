...
var weekFilter = "all";
function weekSet(k) { weekFilter = k; var data = getData(); if (data) renderSessArchive(data); }
function weekCardHtml(d) {
  var items = (d && d.weekly) || [];
  ...
  return '<div class="card"><h2>本周变更（' + items.length + ' 条）</h2>' +
